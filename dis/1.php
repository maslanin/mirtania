...
.menu_j a {
background: #886737 url(pic/bm.png);
border-top: 1px solid #dec49e;
text-decoration: none;
color: #000;
border-bottom: 1px solid #6e5723;
text-shadow: 0px 1px 0px #bda065;
}
.menu_j a:hover { background: #886737; }
a.top_menu_j { display:block;padding:7px; }

.r {
text-align:left;
height:10px;
border-top: 1px solid #946519;
...
.head {background:url(pic/head.png); color: #ffffff; padding: 12px; }
.menu {
...
.main-knopki:hover { color: #ffffff; background: #886737; }
.main-knopki img { display: block; float: left; margin-right: 5px; margin-top: 1px; }
.bodymenu {
display: block;
margin: 1px 0%;
margin-left: -3.7px;
...
.bodymenu:hover { background: #1c1c1c; }
.bodymenu img { display: block; float: left; margin-right: 5px; margin-top: 1px; }
.verx { background: #eb5b13 url(pic/verx.png)repeat-x top left; text-align:center; height:72px; }
</style>';
